<div >
		...
		<span class="User">
			<p style="font-size: 0.75em; font-style: normal; color: red; margin: 0px;" class="hover_pointer" onclick="getAPI()">Get your API <img class="micro" src="images/Very Basic Key.ico"/></p>
