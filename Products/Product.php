<?php
require "ProductsRepository.php";
...
class Product{
	...
	//check if categories of two products are the same
	...
	public function editProduct(){
		...
		$oldProduct->setID($this->getID());	
		if($oldProduct->getProduct("ID", $oldProduct->getID(),$oldProduct)){
